...
4. 参考公开分类清单的类目边界，补充招聘求职、数据分析、身份安全、电商运营、博彩、约会、漫画和休闲论坛等场景；只吸收明确品牌/域名，不整库导入。
...
当前 catalog 有 47 个分组，展开后 1788 条规则：

- `work`：21 组，965 条 pattern
- `entertainment`：20 组，617 条 pattern
- `ignore`：6 组，206 条 pattern

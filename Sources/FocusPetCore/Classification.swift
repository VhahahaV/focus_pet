...
public extension ActivityClassifier {
    ...
    private static let fallbackRules: [ClassificationRule] = [
        ...
        ClassificationRule(matchKind: .appName, pattern: "Codex", category: .work, priority: 500),
        ClassificationRule(matchKind: .bundleID, pattern: "com.openai.codex", category: .work, priority: 500),
        ClassificationRule(matchKind: .appName, pattern: "ChatGPT", category: .work, priority: 500),
        ClassificationRule(matchKind: .appName, pattern: "ChatGPT Atlas", category: .work, priority: 500),
        ClassificationRule(matchKind: .appName, pattern: "Cortex", category: .work, priority: 500),
        ClassificationRule(matchKind: .windowTitle, pattern: "ChatGPT", category: .work, priority: 700),
        ClassificationRule(matchKind: .windowTitle, pattern: "OpenAI", category: .work, priority: 700),
        ClassificationRule(matchKind: .windowTitle, pattern: "Codex", category: .work, priority: 700),
        ClassificationRule(matchKind: .windowTitle, pattern: "GPT", category: .work, priority: 700),
